...
# This will return the sum of sizes of the total directories with a size of at most 1000000
...
def part1():
    ...
    directory_size(outermost_directory)
    ...
    print("The sum of sizes of total directories with a size of at most 100000 is: " + str(total))